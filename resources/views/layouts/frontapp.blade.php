...
<head>
    ...
    <script>
        ...
        window.__lc.license = 13434753;
        ;(function(n,t,c){function i(n){return e._h?e._h.apply(null,n):e._q.push(n)}var e={_q:[],_h:null,_v:"2.0",on:function(){i(["on",c.call(arguments)])},once:function(){i(["once",c.call(arguments)])},off:function(){i(["off",c.call(arguments)])},get:function(){if(!e._h)throw new Error("[LiveChatWidget] You can't use getters before load.");return i(["get",c.call(arguments)])},call:function(){i(["call",c.call(arguments)])},init:function(){var n=t.createElement("script");n.async=!0,n.type="text/javascript",n.src="https://cdn.livechatinc.com/tracking.js",t.head.appendChild(n)}};!n.__lc.asyncInit&&e.init(),n.LiveChatWidget=n.LiveChatWidget||e}(window,document,[].slice))
    </script>
    <noscript><a href="https://www.livechat.com/chat-with/13434753/" rel="nofollow">Chat with us</a>, powered by <a href="https://www.livechat.com/?welcome" rel="noopener nofollow" target="_blank">LiveChat</a></noscript>
...
<div class="container mt-1">
    <div class="row justify-content-center">
        <div class="col-6 col-md-6 col-sm-6 ">
            <a class="btn bg-danger text-white form-control" style="font-size:1.5rem;" href="{{ $links->daftar ?? '#' }}" target="_blank" id="daftar">D A F T A R</a>
        </div>
        <div class="col-6 col-md-6 col-sm-6">
            <a class="btn form-control" style="font-size:1.5rem; background:black; color:gold; font-weight: bold;" href="{{ $links->login ?? '#' }}" target="_blank" id="masuk">M A S U K</a>
        </div>
    </div>
    @yield('front')
</div>
